...
public class AboutUs extends JFrame {
    ...
    public AboutUs() {
        ...
        super("About Us - Guru Tegh Bahadur Institute of Technology");
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/logo.jpg"));
...
//        contentPane.add(l5);
        ...
        JLabel l6 = new JLabel("Name : Prabh Simar Pal Singh");
        l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
        l6.setBounds(70, 198, 600, 35);
        contentPane.add(l6);

        JLabel l7 = new JLabel("EnRoll Number - 04913202818");
        l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l7.setBounds(70, 260, 600, 34);
        contentPane.add(l7);

        JLabel l8 = new JLabel("Email : prabhsimarjassal@gmail.com");
        l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l8.setBounds(70, 290, 600, 34);
        contentPane.add(l8);

        JLabel l9 = new JLabel("Class : 7th Sem (ECE-1)");
        l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
        l9.setBounds(70, 320, 600, 34);
        contentPane.add(l9);


        JLabel l10 = new JLabel("Phone : +91 9958 998877");
