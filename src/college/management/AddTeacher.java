...
public class AddTeacher implements ActionListener {
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/fifth.jpg"));
        ...
        String branch[] = {"Computer Science","Electronics","Electrical","Information Technology"};
