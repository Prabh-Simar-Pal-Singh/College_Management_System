...
public class Project extends JFrame implements ActionListener{
    Project() {
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/main.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon2.png"));
        ...
        JMenuItem u1 = new JMenuItem("Students Details");
        JMenuItem u2 = new JMenuItem("Teachers Details");
        user.setForeground(Color.RED);

        u1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon14.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon14.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon6.png"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon7.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon8.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon11.png"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon13.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("college/management/icons/icon12.png"));
